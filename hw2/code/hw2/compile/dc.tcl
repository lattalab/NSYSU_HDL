...
set Path_Top		"/home/B103040045_HDL/hw2/rtl/"
set Path_Syn		"/home/B103040045_HDL/hw2/gatelevel/Clockgating_delay"
set Dump_file_name "hw2_clock_gating_syn"
#設定Top module 名稱，需跟自行設計之電路的top module name相同
set Top				"hw2_clockgating"
...
#Each Pipeline Delay 
# -through { module instance name/* }
report_timing -from [all_inputs]  > $Path_Syn/in_timing_report.txt
uplevel #0 { report_timing  -through { s1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s1_timing_report.txt}
uplevel #0 { report_timing  -through { s2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s2_timing_report.txt}
