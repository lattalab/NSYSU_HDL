...
read_verilog /home/B103040045_HDL/hw3/code/gatelevel/between/thumb_pipe_between.v
# current_design: set the design top module
current_design thumb
link

# read_sdc and read_sdf: set corresponding SDC and SDF files
read_sdc /home/B103040045_HDL/hw3/code/gatelevel/between/thumb_pipe_between.sdc
read_sdf /home/B103040045_HDL/hw3/code/gatelevel/between/thumb_pipe_between.sdf
...
report_timing -path full -delay max -max_paths 5 -nworst 1 > report_timing_average_vcd_hw3_between.rpt
...
check_power
update_power
report_power -hierarchy > report_power_average_vcd_hw3_between.rpt
