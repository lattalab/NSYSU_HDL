...
# Created by write_sdc on Thu Oct  3 15:26:51 2024
...
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[31]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[30]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[29]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[28]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[27]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[26]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[25]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[24]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[23]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[22]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[21]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[20]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[19]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[18]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[17]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[16]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[15]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[14]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[13]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[12]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[11]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[10]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[9]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[8]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[7]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[6]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[5]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[4]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[3]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[2]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[1]}]
set_output_delay -clock clk  0  [get_ports {s_dataflow_reg[0]}]
set_output_delay -clock clk  0  [get_ports co_dataflow_reg]
