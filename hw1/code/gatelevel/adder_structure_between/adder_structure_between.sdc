...
# Created by write_sdc on Thu Oct  3 15:05:49 2024
...
set_max_area 0
create_clock -name clk  -period 0.619783  -waveform {0 0.309891}
set_max_delay 0.619783  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
