...
# Created by write_sdc on Thu Oct  3 15:28:02 2024
...
create_clock [get_ports clk]  -period 0.618289  -waveform {0 0.309144}
...
set_output_delay -clock clk  0  [get_ports {s_structure_reg[31]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[30]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[29]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[28]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[27]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[26]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[25]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[24]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[23]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[22]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[21]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[20]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[19]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[18]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[17]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[16]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[15]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[14]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[13]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[12]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[11]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[10]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[9]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[8]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[7]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[6]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[5]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[4]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[3]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[2]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[1]}]
set_output_delay -clock clk  0  [get_ports {s_structure_reg[0]}]
set_output_delay -clock clk  0  [get_ports co_structure_reg]
