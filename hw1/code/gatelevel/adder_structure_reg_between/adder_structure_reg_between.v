...
module FA_0 ( sum, c_out, a, b, c_in );
  ...
  ND2D1BWP16P90LVT U1 ( .A1(c_in), .A2(n10), .ZN(n8) );
  INR2D1BWP16P90LVT U2 ( .A1(c_in), .B1(b), .ZN(n2) );
  CKND1BWP16P90LVT U3 ( .I(b), .ZN(n10) );
  OR2D1BWP16P90LVT U4 ( .A1(n7), .A2(a), .Z(n1) );
  ND2D1BWP16P90LVT U5 ( .A1(n8), .A2(n1), .ZN(n4) );
  CKND8BWP16P90LVT U6 ( .I(c_in), .ZN(n7) );
  ND2D1BWP16P90LVT U7 ( .A1(n4), .A2(n5), .ZN(n9) );
  ND2D2BWP16P90LVT U8 ( .A1(n9), .A2(n6), .ZN(c_out) );
  OR2D1BWP16P90LVT U9 ( .A1(n11), .A2(n10), .Z(n6) );
  NR2D1BWP16P90LVT U10 ( .A1(a), .A2(n7), .ZN(n3) );
  ND2D1BWP16P90LVT U11 ( .A1(n2), .A2(n3), .ZN(n5) );
...
module FA_2 ( sum, c_out, a, b, c_in );
  ...
  AO22D2BWP16P90LVT U1 ( .A1(c_in), .A2(n3), .B1(a), .B2(b), .Z(c_out) );
  INVD1BWP16P90 U2 ( .I(c_in), .ZN(n1) );
  CKND1BWP16P90LVT U3 ( .I(n1), .ZN(n2) );
  XNR2D1BWP16P90LVT U4 ( .A1(n2), .A2(n5), .ZN(sum) );
  INVD1BWP16P90LVT U5 ( .I(n5), .ZN(n3) );
...
module FA_3 ( sum, c_out, a, b, c_in );
  ...
  XNR2D1BWP16P90LVT U3 ( .A1(n4), .A2(c_in), .ZN(sum) );
...
module FA_5 ( sum, c_out, a, b, c_in );
  ...
  CKND1BWP16P90LVT U3 ( .I(n5), .ZN(n3) );
  XNR2D1BWP16P90LVT U4 ( .A1(n2), .A2(n5), .ZN(sum) );
  AO22D2BWP16P90LVT U5 ( .A1(n3), .A2(c_in), .B1(a), .B2(b), .Z(c_out) );
  XOR2D1BWP16P90LVT U6 ( .A1(n4), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U7 ( .I(a), .ZN(n4) );
endmodule
...
module FA_9 ( sum, c_out, a, b, c_in );
  ...
  XNR2D1BWP16P90 U3 ( .A1(n1), .A2(n5), .ZN(sum) );
...
module FA_10 ( sum, c_out, a, b, c_in );
  ...
  OAI22D2BWP16P90LVT U4 ( .A1(n5), .A2(n4), .B1(n3), .B2(n2), .ZN(c_out) );
  XOR2D1BWP16P90LVT U5 ( .A1(n3), .A2(b), .Z(n5) );
  INVD1BWP16P90LVT U6 ( .I(a), .ZN(n3) );
  INVD1BWP16P90LVT U7 ( .I(b), .ZN(n2) );
endmodule
...
module FA_11 ( sum, c_out, a, b, c_in );
  ...
  BUFFD1BWP16P90LVT U1 ( .I(c_in), .Z(n1) );
...
module FA_15 ( sum, c_out, a, b, c_in );
  ...
  AO22D1BWP16P90LVT U2 ( .A1(n1), .A2(c_in), .B1(a), .B2(b), .Z(c_out) );
  XNR2D1BWP16P90 U3 ( .A1(c_in), .A2(n3), .ZN(sum) );
...
module FA_16 ( sum, c_out, a, b, c_in );
  ...
  BUFFD1BWP16P90LVT U1 ( .I(c_in), .Z(n1) );
  AO22D1BWP16P90LVT U2 ( .A1(n2), .A2(c_in), .B1(a), .B2(b), .Z(c_out) );
  CKND1BWP16P90LVT U3 ( .I(n4), .ZN(n2) );
  XNR2D1BWP16P90LVT U4 ( .A1(n1), .A2(n4), .ZN(sum) );
