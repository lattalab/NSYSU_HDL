...
# Created by write_sdc on Thu Oct  3 14:48:37 2024
...
set_max_area 0
create_clock -name clk  -period 0.473287  -waveform {0 0.236643}
set_max_delay 0.473287  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
